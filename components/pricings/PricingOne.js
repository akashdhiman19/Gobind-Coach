        ...
        <div className="row">
          <div className="col-lg-12">
            <SectionTitle
              ...
              description="Choose a plan that fits your needs—whether you're just starting out or scaling up. Our pricing is simple, transparent, and designed to grow with your business."
              color="extra04-color"
              alignment="center"
            />
          </div>
